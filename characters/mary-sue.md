...
Name spelling is contested — see OPEN_QUESTIONS.md ("Mary Sue" throughout this dump's body vs. "MerrySue" in the closing character list). This file uses "Mary Sue" since that's the majority usage in this dump.

## Identity
- Per the assistant's in-session roster summary (not 10die's own words, flag accordingly): "reincarnated super, red blood addict."
  source: raw/2026-07-16-brainstorm-session.md, ¶6
- Linked to Keegan (see mechanics/family-link.md) — "he's been fighting with Mary Sue. They have a link," explicitly given as the reason Keegan doesn't share the family orbit-link with his own siblings/parents.
  source: raw/2026-07-16-brainstorm-session.md, ¶2
- Involved in "the whole Mary Sue decree meeting" and "caught up" with someone referred to as "the day queen" — see OPEN_QUESTIONS.md re: day queen/Daiquin/deyKwein likely being the same name transcribed three ways. Context of the "decree meeting" itself is not explained in this dump.
